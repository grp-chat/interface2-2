...
t1 = new TaskCreate(blue, "333", 1, "1x: 4s", "3 tries", "+ 10pts");
t2 = new TaskCreate(pink, "333", 2, "4x: 19s", "1 try", "+ 16pts");
t3 = new TaskCreate(purple, "Cycle", 3, "1x: 20s", "1 try", "+ 17pts");
t4 = new TaskCreate(yellow, "Cycle", 4, "1x: 15s", "1 try", "+ 25pts");
t5 = new TaskCreate(green, "Cycle", 5, "1x: 25s", "1 try", "+ 10pts");
t6 = new TaskCreate(grey, "Cycle", 6, "1x: 21s", "1 try", "+ 13pts");
t7 = new TaskCreate(blue, "363", 7, "1x: 7s", "2 tries", "+ 10pts");
t8 = new TaskCreate(pink, "363", 8, "1x: 5s", "2 tries", "+ 15pts");
t9 = new TaskCreate(purple, "333", 9, "1x: 5s", "2 tries", "+ 10pts");
t10 = new TaskCreate(yellow, "363", 10, "1x: 4s", "3 tries", "+ 20pts");
t11 = new TaskCreate(green, "333", 11, "3x: 15s", "1 try", "+ 12pts");
t12 = new TaskCreate(grey, "363", 12, "2x: 14s", "1 try", "+ 15pts");
t13 = new TaskCreate(blue, "333", 13, "1x: 5s", "2 tries", "+ 10pts");
t14 = new TaskCreate(blue, "363", 14, "1x: 7s", "1 try", "+ 12pts");
t15 = new TaskCreate(green, "H-Cyc", 15, "1x: 20s", "1 try", "+ 10pts");
t16 = new TaskCreate(green, "333", 16, "4x: 18s", "1 try", "+ 16pts");
t17 = new TaskCreate(grey, "H-Cyc", 17, "1x: 15s", "1 try", "+ 15pts");
t18 = new TaskCreate(grey, "363", 18, "2x: 15s", "1 try", "+ 15pts");
t19 = new TaskCreate(pink, "333", 19, "1x: 3s", "3 tries", "+ 20pts");
t20 = new TaskCreate(pink, "363", 20, "1x: 6s", "2 tries", "+ 15pts");
t21 = new TaskCreate(purple, "Cycle", 21, "1x: 19s", "1 try", "+ 18pts");
t22 = new TaskCreate(purple, "333", 22, "4x: 16s", "1 try", "+ 25pts");
t23 = new TaskCreate(yellow, "Cycle", 23, "vs Plyr", "Best of 2", "+ 15pts");
t24 = new TaskCreate(yellow, "363", 24, "1x: 4s", "4 tries", "+ 18pts");
t25 = new TaskCreate(blue, "333", 25, "1x: 5s", "2 tries", "+ 10pts");
t26 = new TaskCreate(pink, "363", 26, "1x: 8s", "1 try", "+ 10pts");
t27 = new TaskCreate(purple, "H-Cyc", 27, "1x: 19s", "1 try", "+ 10pts");
t28 = new TaskCreate(yellow, "333", 28, "4x: 17s", "1 try", "+ 18pts");
t29 = new TaskCreate(green, "363", 29, "2x: 13s", "1 try", "+ 17pts");
t30 = new TaskCreate(grey, "H-Cyc", 30, "1x: 14s", "1 try", "+ 17pts");
t31 = new TaskCreate(blue, "333", 31, "4x: 20s", "1 try", "+ 13pts");
t32 = new TaskCreate(pink, "363", 32, "3x: 20s", "1 try", "+ 17pts");
t33 = new TaskCreate(purple, "Cycle", 33, "1x: 21s", "1 try", "+ 13pts");
t34 = new TaskCreate(yellow, "333", 34, "4x: 15s", "1 try", "+ 25pts");
t35 = new TaskCreate(green, "363", 35, "vs Plyr", "Best of 2", "+ 15pts");
t36 = new TaskCreate(grey, "H-Cyc", 36, "2x: 17s", "1 try", "+ 25pts");
